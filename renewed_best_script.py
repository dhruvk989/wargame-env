...
while running:
   ...
   # Draw drone path
    ...
    for i, enemy in enumerate(enemies):
        ...
        accuracy_text = 'Accuracy Level: 94%'
        accuracy_surface = pygame.font.Font(None, 36).render(accuracy_text, True, (255, 255, 255))
        display.blit(accuracy_surface, (10, display_height - 40))  # Adjust the y-coordinate as needed
